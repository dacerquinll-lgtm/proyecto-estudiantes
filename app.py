...
st.markdown("""
    ...
    .btn-container { display: flex; flex-direction: column; gap: 12px; max-width: 320px; }
    ...
    .illustration-box { display: flex; justify-content: center; align-items: center; margin-top: 25px; }
    </style>
