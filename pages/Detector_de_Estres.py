...
if not st.session_state.iniciado:
    ...
    st.write("Este sistema implementa modelos de **Aprendizaje Automático (Machine Learning)** para analizar tus hábitos académicos.")
...
# --- FLUJO DE CUESTIONARIO ---
    ...
    # Uso de st.write en negrita para evitar la línea divisoria
