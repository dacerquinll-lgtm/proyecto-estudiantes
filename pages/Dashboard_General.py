...
st.markdown(f"""
    ...
    /* Métricas - Fuerza color oscuro */
    [data-testid="stMetricLabel"], [data-testid="stMetricValue"] {{ color: #0c1c30 !important; }}
    
    /* CORRECCIÓN: Notificaciones y textos generales */
    div[data-testid="stNotification"] {{ background-color: #e2e8f0 !important; }}
    div[data-testid="stNotification"] *, div[data-testid="stMarkdown"] {{ color: #0c1c30 !important; }}
    
    /* Tabs */
    button[data-baseweb="tab"] div {{ color: #4a5568 !important; font-weight: bold !important; }}
